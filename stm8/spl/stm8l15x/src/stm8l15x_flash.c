...
/**
  ...
  * @retval None
  */
#ifdef FLASH__SetProgrammingTime
void FLASH_SetProgrammingTime(FLASH_ProgramTime_TypeDef FLASH_ProgTime)
{
  /* Check parameter */
...
/**
  ...
  */
#ifdef FLASH__GetProgrammingTime
FLASH_ProgramTime_TypeDef FLASH_GetProgrammingTime(void)
{
...
/**
  ...
  * @retval None
  */
#ifdef FLASH__PowerWaitModeConfig
void FLASH_PowerWaitModeConfig(FLASH_Power_TypeDef FLASH_Power)
{
  /* Check parameter */
...
/**
  ...
  * @retval None
  */
#ifdef FLASH__ProgramOptionByte
void FLASH_ProgramOptionByte(uint16_t Address, uint8_t Data)
{
  /* Check parameter */
...
/**
  ...
  */
#ifdef FLASH__GetReadOutProtectionStatus
FunctionalState FLASH_GetReadOutProtectionStatus(void)
{
...
/**
  ...
  * @retval None
  */
#ifdef FLASH__PowerRunModeConfig
...
/**
  ...
  * @retval FLASH status
  */
#ifdef FLASH__WaitForLastOperation
