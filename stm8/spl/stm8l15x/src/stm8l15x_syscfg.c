...
/**
  ...
  * @retval None.
  */
#ifdef SYSCFG__RITIMInputCaptureConfig
...
/**
  ...
  * @retval None
  */
#ifdef SYSCFG__RIAnalogSwitchConfig
...
/**
  ...
  * @retval None.
  */
#ifdef SYSCFG__RIIOSwitchConfig
...
/**
  ...
  * @retval None
  */
#ifdef SYSCFG__RIResistorConfig
...
/**
  ...
  * @retval None
  */
#ifdef SYSCFG__REMAPDMAChannelConfig
