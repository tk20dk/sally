...
/**
  ...
  * @retval None
  */
#ifdef EXTI__SetHalfPortSelection
...
/**
  ...
  * @retval None
  */
#ifdef EXTI__SetPortSensitivity
...
/**
  ...
  * @retval The external interrupt sensitivity of the selected port.
  */
#ifdef EXTI__GetPortSensitivity
