...
#else
extern CONST uint8_t SYSDivFactor[5];
#endif
...
/**
  ...
  * @retval None
  */
#if CLK__AdjustHSICalibrationValue
...
/**
  ...
  * @retval None
  */
#ifdef CLK__ClockSecuritySystemEnable
...
/**
  ...
  * @retval None
  */
#ifdef CLK__ClockSecuritySytemDeglitchCmd
...
/**
  ...
  * @retval None
  */
#ifdef CLK__SYSCLKSourceSwitchCmd
...
* @brief  Enables or disables the specified peripheral clock.
  ...
  * @retval None
  */
#ifdef CLK__PeripheralClockConfig
...
/**
  ...
  * @retval None
  */
#ifdef CLK__LSEClockSecuritySystemEnable
...
/**
  ...
  * @retval None
  */
#ifdef CLK__RTCCLKSwitchOnLSEFailureEnable
