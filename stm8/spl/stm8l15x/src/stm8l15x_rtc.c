...
*/
#ifdef RTC__AlarmSubSecondConfig
...
/**
  ...
  * @retval None
  */
#ifdef RTC__DayLightSavingConfig
...
/**
  ...
  * @retval None
  */
#ifdef RTC__TamperSamplingFreqConfig
...
* @retval None
*/
#ifdef RTC__TamperPinsPrechargeDuration
