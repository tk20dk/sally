...
/**
  ...
  * @retval None
  */
#ifdef USART__ReceiverWakeUpCmd
...
/**
  ...
  * @retval None
  */
#ifdef USART__ClearITPendingBit
void USART_ClearITPendingBit(USART_TypeDef* USARTx, USART_IT_TypeDef USART_IT)
{
  (void)USART_IT;
